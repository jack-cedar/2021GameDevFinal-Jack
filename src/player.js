...
export class player{
    ...
    move(){
        ...
        switch (this.cMap[mapIndex(this.nPos[0], this.nPos[1])]){
            ...
            case 0x0f:this.CAN_MOVE = 0;if(this.HAS_KEY==true){this.CAN_MOVE = true;this.gameMap[((this.cMap[mapIndex(this.nPos[0], this.nPos[1])])+this.setTile)]=0x00};break;
    ...
    update(screenMap, map_data, setTile){
        this.cMap = map_data;
